...
//
//int masihAdaKosong(int map[9][9], int &baris, int &kolom, bool keluar){
//	if(keluar)
//		return 1; //kondisi dimana program di pause
//
//	for (int i = 0; i<9; i++){
//		for (int j = 0; j<9; j++){
//			if (map[i][j] == 0){
//				baris = i;
//				kolom = j;
//				return 2; //kondisi dimana program tidak dipause dan true
//			}
//		}
//	}
//	return 3; //kondisi dimana program tidak dipause dan tidak false
//}
...
//	int baris, kolom;
//
//	if (masihAdaKosong(map, baris, kolom, false) == 3){
//		return true;
//	}
//	for (int i = 1; i<10; i++){
...
//	window.display();
//
//	int a = masihAdaKosong(map, baris, kolom, keluar);
//	if (a == 3)
//		return true;
//	else if(a == 1){
//		cout<<"YE";
